                                    ...
                                    <div className="flex-1 min-w-0 pr-8">
                                        {editingDocId === doc.id ? (
                                            <input
                                                ref={inputRef}
                                                type="text"
                                                className={`input input-ghost input-xs w-full font-bold p-0 h-auto focus:outline-none ${currentDocId === doc.id ? "text-primary-content" : "bg-base-100"}`}
                                                value={editingName}
                                        ...
                                        <div className={`text-[10px] flex items-center mt-1 font-bold uppercase tracking-wider ${currentDocId === doc.id ? "text-primary-content/70" : "opacity-50"}`}>
                                            <span
