          ...
          <LocationProvider>
            <main>
              <Router>
                <Route
                  path="/"
                  component={() => <ProtectedRoute component={Client} />}
                />
                <Route
                  path="/requests/:id"
                  component={({ id }: { id: string }) => (
                    <ProtectedRoute component={Client} id={id} type="request" />
                  )}
                />
                <Route
                  path="/history/:id"
                  component={({ id }: { id: string }) => (
                    <ProtectedRoute component={Client} id={id} type="history" />
                  )}
                />
                <Route
                  path="/history"
                ...
                <Route
                  path="/invites"
                  component={() => <ProtectedRoute component={Invites} />}
                />
                <Route
                  path="/mocks"
                  component={() => <ProtectedRoute component={Mocks} />}
                />
                <Route
                  path="/api"
                  component={() => <ProtectedRoute component={ApiDocs} />}
                />
