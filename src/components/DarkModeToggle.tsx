...
export default function DarkModeToggle() {
    ...
    let currentTheme: string = "apispider-light";
    if (typeof window !== "undefined") {
        currentTheme = user?.theme || localStorage.getItem("theme") || "apispider-light";
    }
    ...
    useEffect(() => {
        ...
        const handleSystemThemeChange = async (e: MediaQueryListEvent): Promise<void> => {
